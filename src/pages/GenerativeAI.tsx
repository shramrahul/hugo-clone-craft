    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 mb-12">Generative AI: Is Your Company Ready for Its Opportunities & Challenges?</p>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold mb-6">The Opportunities of Generative AI</h2>
            ...
            <div className="bg-gray-100 rounded-lg p-8 mb-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-bold mb-4">Enhanced Creativity and Innovation</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4">Improved Efficiency</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4">Personalized Experiences</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4">Advanced Problem-Solving</h3>
                  <p className="text-gray-700">
            ...
            <h2 className="text-3xl font-bold mb-6">The Challenges of Generative AI</h2>
            ...
            <h2 className="text-3xl font-bold mb-6">Preparing Your Business for Generative AI</h2>
