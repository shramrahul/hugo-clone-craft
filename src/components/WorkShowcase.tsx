  ...
  return (
    <section id="expertise" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-900 text-center">Our Expertise</h2>
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <div className="text-white text-center p-6">
                  <h3 className="text-xl lg:text-2xl font-semibold mb-2">{sector.title}</h3>
                  <p className="text-sm lg:text-base text-gray-200">{sector.description}</p>
                </div>
              </div>
            </div>
          ))}
