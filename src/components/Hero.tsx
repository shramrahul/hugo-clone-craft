    ...
    <div className="py-24 bg-white">
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 space-y-6 mt-12 lg:mt-0">
          <div className="inline-block px-4 py-2 bg-gray-100 rounded-full text-base text-gray-900">
            Outsourcing+
          </div>
          ...
          <div className="mt-12 bg-[#E5F9FB] p-6 rounded-xl">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-gray-900">How Hugo Helped A Leading Innovator Confront Inclusion Gaps</h3>
